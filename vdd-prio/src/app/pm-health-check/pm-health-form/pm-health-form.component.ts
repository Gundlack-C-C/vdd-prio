...
export const ProjectHealthForm: {[key:string]: {A: string, B: string, description: string}} = {
  ...
  pmmethod: {A: 'methodisches Vorgehen', B: 'fehlendes methodisches Vorgehen', description: 'Das Projektmanagement ist methodisch - Es folgt etablierten Standards)!'},
  stakeholdermgmt: {A: 'Mangelhaftes Stakeholdermanagement', B: 'Gutes Stakeholdermanagement', description: 'Alle Stakeholder sind im Projekt gut integriert - Alle sind bezüglich des Projektstand gut informiert!'},
